<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NavBar.Master" CodeBehind="Index.aspx.vb" Inherits="WEBSNC2024.Index" %>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/Index2.jpg" alt="Image">
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="display-1 text-primary mb-0">30 th</h1>
                    <p class="text-primary mb-4">Anniversary of SNC SOUNDPROOF</p>
                    <h1 class="display-5 mb-4">We make the noise that distracts the car less.</h1>
                    <p class="mb-4">SNC formerly known as SNC Sound proof Co ., Ltd. was incorporated in Thailand on the 27th July 1994 with its principal activity in business is manufacturing of car. Vibration Damping Sheet an important products that use to protect noise in car. Hard Part (Insulator) made help to quiet engine noise and keep the heat. Resin Felt for heat insulation and sound insulation in automotive industry. As shown in the picture below are used in a vehicle.We are ready to publish a policy for Occupational Health and Safety The Company is ready to publish health and Safety Policy Employees and the publish to know and understand the user of valuable resources .</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-4 text-white" data-toggle="counter-up">1252222</h1>
