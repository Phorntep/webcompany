<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterpageBill.Master" CodeBehind="Billing_supplier.aspx.vb" Inherits="Billing_SNC.Billing_supplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%; height: auto; margin: 0 auto;">
        <div style="width: 1000px; margin: 0 auto; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2),0 12px 40px 0 rgba(0,0,0,0.19); background-color: aliceblue; padding-bottom: 30px;">
            ...
            <div style="width: 1000px; margin: 0 auto; height: auto; background-color: aliceblue; border: 1px solid groove; border-radius: 0px 0px 0px 0px;">
                <div style="text-align: right; padding-top: 10px; float: left; width: 300px;">
                    <asp:Label runat="server" Text="Invioce Date : " Font-Size="25px"></asp:Label>
                </div>
                <div style="text-align: left; padding-top: 10px; float: left;">
                    <asp:TextBox runat="server" ID="txt_date_invoice" Text="" Enabled="true"  Font-Size="25px" CssClass="txtbox_supplier form_datetime"></asp:TextBox>
                     <font  style="color:red;font-size:25px;">**</font>
                </div>
                <div style="clear: left;">
                </div>
            ...
            <div style="width: 1000px; margin: 0 auto; height: auto; background-color: aliceblue; border: 1px solid groove; border-radius: 0px 0px 0px 0px;">
                ...
                <div runat="server" id="Div1" style="margin: 0 auto; width: 90%; margin-top: 10px;"> 
                    <asp:Label ID="Label1" runat="server" Text="Upload Excel : "> </asp:Label>
                    <asp:FileUpload ID="FileUpload2" runat="server" />
                    &nbsp;
                <asp:Button ID="btn_UploadExcel" runat="server" Text="Upload" OnClick="btn_UploadExcel_Click" />
                     &nbsp;
                    <asp:LinkButton ID="Link_download_format" runat="server" OnClick="Link_download_format_Click">Down Load Format File Upload</asp:LinkButton>
                    <div style="display:block none" hidden="hidden" >
                          <asp:FileUpload ID="FileUpload3" runat="server"  />
                      <asp:Button ID="btnHideUpload" runat="server" Text="Upload" OnClick="btnHideUpload_Click"  />
                    </div>
               </div>
            </div>
            <br />
           ...
           <div style="width: 1000px; margin: 0 auto; height: auto; background-color: aliceblue; border: 1px solid groove; border-radius: 0px 0px 0px 0px;">
                ...
                <div style="text-align: center; padding-top: 10px; margin: 0 auto;">
                    <asp:Button runat="server" Text="Save" CssClass="btn_add_invioce" ID="btn_Save"   Visible="true" />
