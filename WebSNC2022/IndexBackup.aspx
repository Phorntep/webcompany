<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IndexBackup.aspx.vb" Inherits="WEBSNC2022.Index" %>
...
<body>
    <%--<div style="display:flex; z-index"><video id="myVideo" src="Image/travel.mp4" muted="muted" loop="loop" autoplay="autoplay"/></div>--%>
      <header>
